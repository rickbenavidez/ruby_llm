  ...
  module Providers
    class Bedrock
      ...
      module Chat
        ...
        def render_payload(messages, tools:, temperature:, model:, thinking:, thinking_budget:, stream: false, schema: nil) # rubocop:disable Lint/UnusedMethodArgument,Metrics/ParameterLists
          @model_id = model.id
